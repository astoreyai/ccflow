...
- New test `test_stop_hook_receives_last_response` verifying response text availability
...
[0.2.2]: https://github.com/astoreyai/ccflow/releases/tag/v0.2.2
[0.2.1]: https://github.com/astoreyai/ccflow/releases/tag/v0.2.1
